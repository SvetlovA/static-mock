...
internal class InstanceTranspilerHookBuilder : IHookBuilder
{
    private readonly IReadOnlyList<ItParameterExpression> _itParameterExpressions;
    private readonly MethodInfo _originalMethodInfo;

    public InstanceTranspilerHookBuilder(MethodInfo originalMethodInfo, IReadOnlyList<ItParameterExpression> itParameterExpressions)
    {
    ...
    public MethodInfo CreateReturnHook<TReturn>(TReturn value)
    {
        ...
        ReturnHookTranspiler<TReturn>.HookMethodType = HookMethodType.Instance;
    ...
    public MethodInfo CreateReturnAsyncHook<TReturn>(TReturn value)
    {
        ...
        ReturnAsyncHookTranspiler<TReturn>.HookMethodType = HookMethodType.Instance;
    ...
    public MethodInfo CreateThrowsHook<TException>(TException exception) where TException : Exception, new()
    {
        ...
        ThrowsHookTranspiler<TException>.HookMethodType = HookMethodType.Instance;
    ...
    private MethodInfo CreateReturnHookInternal(object getValue)
    {
        ...
        ReturnHookTranspiler.HookMethodType = HookMethodType.Instance;
    ...
    private MethodInfo CreateCallbackHookInternal(object callback)
    {
        ...
        CallbackHookTranspiler.HookMethodType = HookMethodType.Instance;
