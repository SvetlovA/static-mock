...
public class GenericSetupMockReturnsAsyncTests
{
    ...
    public async Task TestGenericSetupReturnsAsyncMethodsReturnTask()
    {
        ...
        using var _ = Mock.Setup(() => TestStaticAsyncClass.TestMethodReturnTaskWithoutParameters()).ReturnsAsync(expectedResult);
    ...
    public async Task TestGenericSetupReturnsAsyncMethodsReturnTaskAsync()
    {
        ...
        using var _ = Mock.Setup(() => TestStaticAsyncClass.TestMethodReturnTaskWithoutParametersAsync()).ReturnsAsync(expectedResult);
    ...
    public async Task TestGenericSetupInstanceReturnsAsyncMethodsReturnTask()
    {
        ...
        using var _ = Mock.Setup(() => instance.TestMethodReturnTaskWithoutParameters()).ReturnsAsync(expectedResult);
    ...
    public async Task TestGenericSetupInstanceReturnsAsyncMethodsReturnTaskAsync()
    {
        ...
        using var _ = Mock.Setup(() => instance.TestMethodReturnTaskWithoutParametersAsync()).ReturnsAsync(expectedResult);
    ...
    public async Task TestGenericSetupReturnsWithTestMethodReturnWithoutParameterFuncAsync()
    {
        ...
        using (Mock.Setup(() => TestStaticAsyncClass.TestMethodReturnTaskWithoutParametersAsync())
    ...
    public async Task TestGenericSetupReturnsWithTestMethodReturnParameters2FuncAsync()
    {
        ...
        using (Mock.Setup(context => TestStaticAsyncClass.TestMethodReturnWithParametersAsync(context.It.IsAny<int>(), context.It.IsAny<string>()))
    ...
    public async Task TestGenericSetupReturnsWithTestMethodReturnParameters3FuncAsync()
    {
        ...
        using (Mock.Setup(context => TestStaticAsyncClass.TestMethodReturnWithParametersAsync(
